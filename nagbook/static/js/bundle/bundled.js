        ...
        return (
            React.createElement("div", {key: key}, 
                React.createElement("label", null, 
                    React.createElement("input", {type: inputType, value: i}), a
                )
            )
        );
    },
...
var Question = React.createClass({displayName: "Question",
    ...
    displayAnswer: function(index) {
        ...
        var nodes = [
            React.createElement("input", {type: "text", defaultValue: value, ref: r})
        ];

        if (this.state.errors[r]) {
            nodes.push(React.createElement("span", null, this.state.errors[r]));
        };
        if (this.state.edit) {
            return (
                React.createElement("div", null, 
    ...
    displayQuestion: function() {
        ...
        if (this.state.errors["ans"]) {
            nodes.push(
                React.createElement("span", null, this.state.errors["ans"])
            );
        };
        if (this.state.edit) {
            return (
    ...
    render: function() {
        ...
        if (this.props.data.aCount) {
            ...
            for (var i=0; i<this.props.data.aCount; i++) {
                answer_list.push(
                    React.createElement("li", {key: "answ"+i}, 
            ...
            answers = (
                React.createElement("div", null, 
                    React.createElement("p", null, "Варианты ответов: "), 
                    React.createElement("ol", null, answer_list)
                )
            );
        } else {
            answers = [];
        ...
        if (this.state.edit) {
            btn = (
                React.createElement("button", {onClick: this.handleSaveClick}, 
                    "Сохранить вопрос"
                )
            );
        } else {
...
if (node_ans) {
    React.render(
        React.createElement(AnswerForm, {source: $(node_ans).data('url')}),
        node_ans
    );
};
...
},{"object-assign":6,"react":161}],6:[function(require,module,exports){
'use strict';
